...
// Можно записать и в таком варианте, т.е. сразу засунуть ф-цию обработчик без названия в событие click
...
var efjih = function (event) {
  $("#m-heading").offset({
    left: event.pageX,
    top: event.pageY
  });
};
$("html").mousemove(efjih);

// В учебнике записано в таком варианте, т.е. сразу засунуть ф-цию обработчик без названия в событие mousemove
